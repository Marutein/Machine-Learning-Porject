...
drop <- c("SalePriceCH", "SalePriceMM", "ListPriceDiff")
...
show_best(purchase_tune, metric = "accuracy", n = 5)
show_best(purchase_tune, metric = "sens", n = 5)
show_best(purchase_tune, metric = "spec", n = 5)
show_best(purchase_tune, metric = "bal_accuracy", n = 5)
